...
CATdesktop is provided under a source-available model for strictly personal, non-commercial use only.

- You can view, download, and run the application or source code for your own personal purposes.

- You may fork this repository on GitHub, provided that your fork remains for personal use and clearly maintains the original copyright notice and attribution to Filip Domanski.


You may not:

 - Host, publish, or redistribute the code or application in any form, whether modified or unmodified, to any third party or public platform (outside of a personal GitHub fork).

 - Use this code, or any derivative works, to create a competing product, service, or public distribution.

 - Monetize, sell, or offer the code or application as a service, nor use it within any commercial context.

 - Distribute or publicly host the code or application for non-profit, educational, or organizational purposes without explicit written permission.

Filip Domanski remains the exclusive official host and distributor of CATdesktop. Any public distribution, deployment, or hosting of this software by anyone else is strictly prohibited.

For commercial licensing, redistribution inquiries, or alternative use cases, please contact the copyright holder.
