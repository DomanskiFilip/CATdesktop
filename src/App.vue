  ...
  <section v-if="loggedIn" id="main-page">
    <section id="side-bar">
      ...
      <button @click="changeSection('section1')" :class="{ active: activeSection === 'section1' }">
        ...
        <span class="moreInfo">CALLENDAR</span>
      </button>
      <button @click="changeSection('section2')" :class="{ active: activeSection === 'section2' }">
        <svg width="25px" height="25px" viewBox="0 0 427 341"  stroke="#F0F0F0" stroke-width="20" xmlns="http://www.w3.org/2000/svg">
      ...
      <button @click="changeSection('section3')" :class="{ active: activeSection === 'section3' }">
        <svg xmlns="http://www.w3.org/2000/svg" height="25px" viewBox="0 -960 960 960" width="25px" fill="#F0F0F0">
    ...
    <section id="main-content">
      ...
      <section v-show="activeSection === 'section3'">Settings Content</section>
    </section>
  </section>
