  ...
  >
      ...
      <button
        @click="
          async () => {
            ...
            emit('event-saved'); /* emit event-saved to refresh calendar */
          }
        "
    ...
    <section id="main-content">
      ...
      >
        ...
        <Notifications />
        <Location
          @updateCoordinates="handleLocationUpdate"
          @updateLocationName="handleLocationNameUpdate"
        />
...
onMounted(async () => {
  ...
  if (!isMobile.value) {
    try {
      autoLaunchEnabled.value = (await invoke(
